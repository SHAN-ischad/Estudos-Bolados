...
export function GlobalButton({ height, text, backgroundColor, width, paddindg, fontSize, fontBold, marginBottom, marginTop, action, }: GlobalButtonProps) {
    return (
        <>
            <Pressable
                onPress={action}
                className={`w-[${width} h-[${height}px] flex-row items-center ${backgroundColor} p-[${paddindg}px] mt-[${marginTop}] mb-[${marginBottom}] rounded-xl hover:opacity-90 active:opacity-40 duration-[300ms] group gap-[5px]`}>
